...
const ResetForm = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-cover bg-center mt-8" 
            ...
            <div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-[#3B9E3F] text-white rounded-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                >
                  Kirim Kode
                </button>
              </div>
